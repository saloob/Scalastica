...
<?php
       ...
       for ($cnt=0;$cnt < count($ci_items);$cnt++){
           ...
           $cis .= "<div style=\"".$divstyle_white."\">".$image." ".$edit."<a href=\"#\" onClick=\"Scroller();loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=view&value=".$id."&valuetype=".$do."');return false\"><B>".$name."</B></a>".$show_id."</div>";
   ...
   case 'csv_upload':
    ...
    /*
    echo "<iframe src='CSV.php?action=csv_get&cit=".$val."' height=500 width=98%></iframe>";
    echo "<iframe src='CSV.php?action=manage&cit=".$val."' height=500 width=98%></iframe>"; 
    */
    echo "<iframe src='CSV.php?action=sports&cit=".$val."' height=500 width=98%></iframe>";
...
*/
    if (!$error){
       ...
       $process_message = "Configuration Item Type Submission was a success! Please review <a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=view&value=".$val."&valuetype=".$valtype."');return false\">here</a> || <a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=edit&value=".$val."&valuetype=".$valtype."');return false\"><font size=2 color=red><B>[".$strings["action_edit"]."]</B></font></a><P>";

       if ($_POST['sclm_configurationitemtypes_id_c'] != NULL){
          $process_message .= "View Parent Configuration Item Type <a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=view&value=".$_POST['sclm_configurationitemtypes_id_c']."&valuetype=".$valtype."');return false\">here!</a><P>";
          }
