...
//		$actual_file_name = isset($_REQUEST['ax-file-name']) ? $_REQUEST['ax-file-name']:$_FILES['ax_file_input']['name'];
//                $file_ext = strtolower( pathinfo($this->file_name, PATHINFO_EXTENSION) );
//		$this->file_name = date("Y-m-d-G-i-s")."[]".$actual_file_name;
	 ...
	 */
	public function setMaxFileSize($max_file_size = '50M')
	{
	...
	public function setEmail($main_receiver, $from='jyoho@scalastica.com')
	{
		$this->mail_receiver 	= $main_receiver;
		$this->mail_cc 			= '';
		$this->mail_from 		= $from ? $from : 'jyoho@scalastica.com';
	}
