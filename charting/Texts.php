 ...
 *
 * <p>Description: Text message and dialogue static finalants</p>
 *
...
class Texts {
    ...
    protected function Texts() {} // Prevent instantiation
    ...
    public static $Copyright = " 1995-2010 by Steema Software";
    public static $VersionMode = "EVALUATION VERSION";
    public static $BuildNumber = "1.6.16.000";

    public static $POLAR_DEGREE_SYMBOL = '\u00b0';
    ...
    public static $ColumnSeparator = '\u0006'; // To separate columns in Legend
