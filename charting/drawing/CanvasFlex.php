<?php
  ...
  class Graphics3DFlex extends GraphicsGD 
  {
    ...
    public function Graphics3DFlex($fhandle,$c)
    {
    ...
    {
      if ($graphic->RawFormat == ImageExport::getPNG()) //.Bmp)
      {
...
*/
    ...
    public function clipPolygon(/*params Point[]*/ $p)
    {                                         
      //throw new Exception("The method or operation is not implemented.");
    }
    ...
    */
    ...
    public function DrawBeziers(/*params Point[]*/ $p)
    {
      //throw new Exception("The method or operation is not implemented.");
    }
