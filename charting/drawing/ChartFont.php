...
class ChartFont extends TeeBase
{
   ...
   public static $DEFAULTFAMILY = "fonts/verdana.ttf";// Arial;;
//   public static $DEFAULTFAMILY = "fonts/DejaVuSansCondensed.ttf";// Arial;;
   public $fontCondensed;
   public $fontCondensedBold;



   public function ChartFont($c = null)
   {
...
//      $this->fontCondensed = $baseDir . "fonts/DejaVuSansCondensed.ttf";
      ...
      self::$DEFAULTFAMILY = $baseDir . "fonts/verdana.ttf";// Arial;
