 ...
 */
     ...
     class DataExport {
        ...
        public function DataExport($c=null) {
            $this->chart=$c;
        }
     ...
     class ColorPersistenceDelegate /*extends DefaultPersistenceDelegate*/ {
        ...
        public function ColorPersistenceDelegate($constructorPropertyNames) {
    ...
    class TemplateExport {
        ...
        public function TemplateExport($c=null) {
            $this->chart=$c;
        }
