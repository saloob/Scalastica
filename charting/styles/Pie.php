    ...
    */
    ...
    private function calcAngles() {
       ...
       // todo remove  $tmpSumAbs; //  = $this->getYValues()->getTotalABS();
        ...
        if ($this->otherSlice->getStyle() == PieOtherStyles::$NONE && $this->firstVisible != -1)
        {
          $tmpSumAbs = 0;
...
//
     ...
     */
     class PieOtherSlice extends TeeBase {
        ...
        public function PieOtherSlice($c, $s) {
    ...
    final class ExplodedSliceList extends ArrayObject {
        ...
        * The class constructor.
        */
        public function ExplodedSliceList() {
            parent::__construct();
        }
