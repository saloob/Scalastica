...
// TODO       return $this->customMarkText->getMarkText($valueIndex, $tmpResult);
   ...
   */
   ...
   protected function draw()
   {
      ...
      {
         for($t = $lastVisible; $t >= $this->firstVisible; $t--)
         {
            $this->drawValue($t);
         }
      }
   ...
   */
   public function checkDataSource()
   {
      ...
      */
      ...
      public function getValueIndexSwapper()
      {
      ...
      */
      public function addXYTextColor($x, $y, $text="", $color=null)
      {
         ...
         if(($text != null))
         {
            ...
            {
               $this->sLabels[sizeof($this->sLabels)]=$text;
            }
...
//                  $tmpResult = parent::toString();
      ...
      */
      ...
      {
         return $this->percentDecimal->format(($this->mandatory->getTotalABS() == 0) ? 100 :
