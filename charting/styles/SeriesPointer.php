...
/**
 ...
 class SeriesPointer extends TeeBase {
    ...
    // Constructor
    public function SeriesPointer($c, $s) {
...
*/
    ...
    /* todo check why protected*/ public function drawLegendShape($g, $color, $rect, $drawPen) {
     ...
     /*todo check  why protected*/ public function calcHorizMargins($margins) {
    ...
    /*todo check  why protected*/ public function calcVerticalMargins($margins) {
        if ($this->bVisible && $this->inflate) {
