...
# case 'Billing':
   ...
   echo "<div style=\"".$formtitle_divstyle_grey."\"><center><font size=3><B>".$strings["Billing"]."</B></font></center></div>";
   echo "<BR><img src=images/blank.gif width=90% height=5><BR>";
   echo "<BR><center><img src=images/icons/Accounting.png width=150></center><BR>";
   echo "<BR><img src=images/blank.gif width=90% height=5><BR>";

   echo "<center>
<a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=list&value=".$last_month_full."&valuetype=bydate&sendiv=".$BodyDIV."');return false\"><font size=3><B>".$last_month_full."</B></font></a> | 
<a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=list&value=".$this_month_full."&valuetype=bydate&sendiv=".$BodyDIV."');return false\"><font size=3><B>".$this_month_full."</B></font></a>";
...
*/
  ...
  if ($_POST['date_from']){
     ...
     echo "<P><center><B>Selected From Date: ".$selected_date_from."</B><P>";
  ...
  if ($_POST['date_to']){
     ...
     echo "<P><center><B>Selected To Date: ".$selected_date_to."</B><P>";
  ...
  #echo "<P>Raw Query: ".$tickets_filter."<P>";

  #exit;

  echo "For billing purposes, it is recommended to not include tickets with the following statuses:<BR><B>Cancelled, Open Un-claimed</B><P>";
