   ...
   case 'RelatedAccountSharing':
    ...
    switch ($action){
     ...
     case 'list':
      ...
      echo "<div style=\"".$formtitle_divstyle_grey."\"><center><font size=3><B>".$strings["RelatedAccountSharing"]."</B></font></center></div>";
   ...
   case 'EmailFilteringSet':
    ...
    switch ($action){
     ...
     case 'list':
      ...
      echo "<div style=\"".$formtitle_divstyle_grey."\"><center><font size=3><B>".$strings["EmailFiltering"]."</B></font></center></div>";
      echo "<BR><img src=images/blank.gif width=90% height=5><BR>";
...
*/
      ...
      if (is_array($filterbits)){
         ...
         for ($cntfb=0;$cntfb < count($filterbits);$cntfb++){
             ...
             $enabled = $filterbits[$cntfb]['enabled'];
...
//dbcb0dbb-c3b8-8edb-1bd6-52b8e31ff812
   ...
   case 'Infrastructure':
    ...
    echo "<div style=\"".$formtitle_divstyle_grey."\"><center><font size=3><B>".$strings["InfraConfiguration"]."</B></font></center></div>";
    echo "<BR><img src=images/blank.gif width=90% height=5><BR>";
      ...
      if (is_array($ci_items)){
         ...
         for ($cnt=0;$cnt < count($ci_items);$cnt++){
             ...
             if ($ci_type_id == '78fdc61d-6ce5-1172-a55a-52c7048a48c7'){ // invoice_day
                ...
                } elseif ($ci_type_id == '9dc21c7b-6279-dfd3-3663-51b2f0489807'){ // portal_skin
...
//      $tablefields[$tblcnt][9][4] = " sclm_configurationitemtypes_id_c='9dc21c7b-6279-dfd3-3663-51b2f0489807' && account_id_c='NULL' ";
      $tablefields[$tblcnt][9][4] = " sclm_configurationitemtypes_id_c='9dc21c7b-6279-dfd3-3663-51b2f0489807' && cmn_statuses_id_c != '".$standard_statuses_closed."' ";
