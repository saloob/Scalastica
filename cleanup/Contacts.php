...
//    $sec_params[0] .= " cmn_statuses_id_c != '".$standard_statuses_closed."' ";
  ...
  switch ($action){
   ...
   case 'list':
    ...
    echo "<div style=\"".$divstyle_grey."\"><center><font size=3><B>".$strings["Contacts"]."</B></font></center></div>";
    ...
    switch ($valtype){
     ...
     case 'Accounts':
      ...
      if ($sec_params[0]){
         $contact_params[0] = $sec_params[0]." && account_id='".$val."' ";
         } else {
         $contact_params[0] = " account_id='".$val."' ";
         }
...
#           $sendmessage = "<a href=\"#\" onClick=\"loader('light');document.getElementById('light').style.display='block';doBPOSTRequest('light','Body.php', 'pc=".$portalcode."&do=Messages&action=add&value=".$contact_id."&valuetype=".$do."&div=light');document.getElementById('fade').style.display='block';loader('".$RightDIV."');doRPOSTRequest('".$RightDIV."','Body.php','pc=".$portalcode."&do=".$do."&action=view&value=".$contact_id."&valuetype=".$do."');return false\"><img src=images/icons/MessagesIcon-100x100.png width=16 alt='".$strings["Message"]."'></a>";

            $sendmessage = "<a href=\"#Top\" onClick=\"loader('light');document.getElementById('light').style.display='block';doBPOSTRequest('light','Body.php', 'pc=".$portalcode."&do=Messages&action=add&value=".$contact_id."&valuetype=Contacts&sendiv=light&related=".$valtype."&relval=".$val."');document.getElementById('fade').style.display='block';return false\"><img src=images/icons/MessagesIcon-100x100.png width=16 alt='".$strings["Message"]."'>".$agent_name."</a> ";
           ...
           $this_contact = $country." ".$edit."<a href=\"#Top\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=view&value=".$contact_id."&valuetype=".$do."');return false\"><font color=#151B54>".$first_name." ".$last_name."</font></a> ".$sendmessage."<BR>";
...
*/
   ...
   case 'view-short':
    ...
    if ($val != $sess_contact_id && $val != NULL){
       ...
       $profile .= "<div style=\"".$divstyle_grey."\"><center><h2>".$portal_title." ".$strings["AccountInformation"]."</h2></center></div>";
...
//         $show_name = $cloakname;
       ...
       if (!$profile_photo){
          $profile_photo = "http://www.scalastica.com/images/profile_photo_default.png";
          }

       $profile .="<div style=\"".$divstyle_white."\"><div style=\"width:400;height:250;\"><center><img src=".$profile_photo." width=200></center></div><P><div><font size=3><B>Profile Name</B>:</font> <a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=Contacts&action=view&value=".$val."&valuetype=Contacts');return false\"><B><font color=#151B54><font size=3>".$show_name."</font></font></B></a></div><P><div>".$twitter."<BR>".$linkedin."<BR><font size=2>".$contact_description."</font></div></div>";
