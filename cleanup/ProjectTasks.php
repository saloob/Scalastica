   ...
   if ($account_id_c){
    ...
    switch ($auth){
     ...
     case 1:
      ...
      $task_menu .= "<center><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=summary&value=".$today."&valuetype=date');return false\"><font size=4><B>".$today."</B></font></a></center>";
    ...
    $task_menu .= "<BR><center><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=list&value=".$val."&valuetype=".$valtype."');return false\"><font size=4><B>".$strings["ProjectTasks"]."</B></font></a></center>";
...
//        $chart2->getChart()->getHeader()->setText($strings["TicketSummaryByStatus"]);
   ...
   case 'list':
    ...
    function wrap_tasks ($task_params){
     ...
     if (is_array($project_task_items)){
        ...
        for ($task_cnt=0;$task_cnt < count($project_task_items);$task_cnt++){
            ...
            $edit = "";
            $edit = "<a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=edit&value=".$task_id."&valuetype=".$valtype."');return false\"><font size=2 color=red><B>[".$strings["action_edit"]."]</B></font></a>";
               ...
               */
               ...
               if (is_array($ci_items)){
                  ...
                  for ($slareqcnt=0;$slareqcnt < count($ci_items);$slareqcnt++){
                      ...
                      $createticket .= "<BR><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=Ticketing&action=add&value=".$task_id."&valuetype=ProjectTasks&sclm_serviceslarequests_id_c=".$sla_req_id."');return false\"><img src=images/icons/SupportTicket.jpg width=16><font color=#151B54><B>Create Ticket [".$sla_req_name."]</B></font></a>";

                      } // for

                  $createticket .= "<BR><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=AccountsServices&action=list&value=".$task_id."&valuetype=ProjectTasks');return false\"><img src=images/icons/uu.png width=16><font color=#151B54><B>Find Service for Task</B></font></a>";
               ...
               $addsubtask = "<BR><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=ProjectTasks&action=add&value=".$task_id."&valuetype=ProjectTasks');return false\"><img src=images/icons/plus.gif width=16><font color=#151B54><B>Add Sub-task</B></font></a>";
    ...
    if ($valtype == 'Search' || $val != NULL){
       echo "<div style=\"".$divstyle_grey."\"><center><font size=3><B>".$strings["ProjectTasks"]."</B></font></center></div>";
           ...
           if (is_array($project_task_items)){
              ...
              for ($taskcnt=0;$taskcnt < count($project_task_items);$taskcnt++){
                  ...
                  if ($sess_contact_id != NULL && $sess_contact_id==$record_contact_id_c || $sess_contact_id != NULL && $sess_contact_id==$account_admin){
                     ...
                     $edit .= " <a href=\"#Top\" onClick=\"loader('lightfull');document.getElementById('lightfull').style.display='block';doBPOSTRequest('lightfull','Body.php', 'pc=".$portalcode."&do=ProjectTasks&action=edit&value=".$id."&valuetype=".$valtype."&sendiv=lightfull');document.getElementById('fade').style.display='block';return false\"><font size=2 color=red><B>[Quick ".$strings["action_edit"]."]</B></font></a> ";
                     }
                     ...
                     */
                     ...
                     if (is_array($ci_items)){
                        ...
                        for ($slareqcnt=0;$slareqcnt < count($ci_items);$slareqcnt++){
                            ...
                            $sla_req_id = $ci_items[$slareqcnt]['id'];
                            $sla_req_name = $ci_items[$slareqcnt]['name'];
                            $createticket .= "<BR><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=Ticketing&action=add&value=".$id_c."&valuetype=ProjectTasks&sclm_serviceslarequests_id_c=".$sla_req_id."');return false\"><img src=images/icons/SupportTicket.jpg width=16><font color=#151B54><B>Create Ticket [".$sla_req_name."]</B></font></a>";

                            } // for

                        $createticket .= "<BR><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=AccountsServices&action=list&value=".$id_c."&valuetype=ProjectTasks');return false\"><img src=images/icons/uu.png width=16><font color=#151B54><B>Find Service for Task</B></font></a>";
                     ...
                     $addsubtask = "<BR><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=ProjectTasks&action=add&value=".$id."&valuetype=ProjectTasks');return false\"><img src=images/icons/plus.gif width=16><font color=#151B54><B>Add Sub-task</B></font></a>";

                     } # if status

                  $projecttasks .= "<div style=\"".$divstyle_white."\"><div style=\"width:20%;float:left;padding-top:5;\"><center>".$status_image."<BR><font size=2>[".$status_name."]</font></center></div><div style=\"width:80%;float:left;padding-top:3;\">[".$date_start."]->[".$date_due."]<BR>[#".$task_number."] [".$percent_complete."%] ".$edit." <a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=view&value=".$id."&valuetype=".$valtype."');return false\"><B>".$name."</B></a>".$addsubtask.$createticket."</div></div>";
               ...
               */
               ...
               if (is_array($ci_items)){
                  ...
                  for ($slareqcnt=0;$slareqcnt < count($ci_items);$slareqcnt++){
                      ...
                      $sla_req_id = $ci_items[$slareqcnt]['id'];
                      $sla_req_name = $ci_items[$slareqcnt]['name'];
                      $createticket .= "<BR><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=Ticketing&action=add&value=".$id."&valuetype=ProjectTasks&sclm_serviceslarequests_id_c=".$sla_req_id."');return false\"><img src=images/icons/SupportTicket.jpg width=16><font color=#151B54><B>Create Ticket [".$sla_req_name."]</B></font></a>";

                      #$dd_pack['683bb5f7-e1c7-4796-8d23-52b0df65369f[]'.$val.'[]'.$id.'[]RELATIONSHIPS'] = $strings["ServiceSLARequests"]." : ".$name;

                      } // for

                  $createticket .= "<BR><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=AccountsServices&action=list&value=".$id."&valuetype=ProjectTasks');return false\"><img src=images/icons/uu.png width=16><font color=#151B54><B>Find Service for Task</B></font></a>";
       ...
       for ($cnt=0;$cnt < count($project_cstm_items);$cnt++){
           ...
           if (is_array($project_task_items)){
              ...
              for ($taskcnt=0;$taskcnt < count($project_task_items);$taskcnt++){
                  ...
                  $name = "<a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=edit&value=".$id."&valuetype=".$do."');return false\"><font color=red>[".$strings["action_edit"]."]</font></a> <a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=view&value=".$id."&valuetype=".$do."');return false\"><font color=white><B>".$name."</B></font></a>";
...
*/
    ...
    if (($action == 'view' || $action == 'edit') || ($action == 'add' && $record_projecttask_id_c != NULL) && !$sendiv){
       ...
       echo "<center><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=AccountsServices&action=list&value=".$parent_account_id."&valuetype=Parent&source=".$do."&sourceval=".$val."');return false\" class=\"css3button\"><B>".$strings["AttachServicesTask"]."</B></a></center>";
...
*/
   ...
   case 'process':
    ...
    if (!$error){
       ...
       $process_message = $strings["SubmissionSuccess"]."<P><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=edit&value=".$val."&valuetype=".$valtype."');return false\">".$strings["action_edit"]."</a> || <a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$do."&action=view&value=".$val."&valuetype=".$valtype."');return false\">".$strings["action_view_here"]."</a><P>";
