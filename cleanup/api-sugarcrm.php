...
//         $parent_id = dlookup("sclm_configurationitemtypes", "name", "id='".$returnpack[$cnt]['ci_type_id']."'");
 ...
 case 'ConfigurationItems_Common':
  ...
  switch ($action){
   ...
   $final_query = "SELECT $select FROM cmn_configurationitems $query $group $order $limit";
   ...
   while ($the_row = mysql_fetch_array ($the_list)){
         ...
         $returnpack[$cnt]['deleted'] = $the_row['deleted'];        
         $returnpack[$cnt]['assigned_user_id'] = $the_row['assigned_user_id'];
         $returnpack[$cnt]['ci_type_id'] = $the_row['cmn_configurationitemtypes_id_c'];

         if ($returnpack[$cnt]['ci_type_id']){
            $ci_type_name = dlookup("cmn_configurationitemtypes", "name", "id='".$returnpack[$cnt]['ci_type_id']."'");
            $returnpack[$cnt]['ci_type_name'] = $ci_type_name;
            }
   ...
   case 'update':
    ...
    $set_entry_params = array(
   'session' => $sugar_session_id,
              'module_name' => 'cmn_ConfigurationItems',
              'name_value_list'=> $params
    );
 ...
 break; // end ConfigurationItems_Common
 ...
 case 'ConfigurationItemItems':
  ...
  switch ($action){
   ...
   $final_query = "SELECT $select FROM sclm_configurationitemitems $query $group $order $limit";
   ...
   while ($the_row = mysql_fetch_array ($the_list)){
         ...
         $returnpack[$cnt]['deleted'] = $the_row['deleted'];        
         $returnpack[$cnt]['assigned_user_id'] = $the_row['assigned_user_id'];
         $returnpack[$cnt]['ci_id'] = $the_row['sclm_configurationitems_id_c'];
         $returnpack[$cnt]['related_ci_id'] = $the_row['sclm_configurationitems_id1_c'];
         $returnpack[$cnt]['account_id_c'] = $the_row['account_id_c'];
         $returnpack[$cnt]['contact_id_c'] = $the_row['contact_id_c'];
         $returnpack[$cnt]['cmn_statuses_id_c'] = $the_row['cmn_statuses_id_c'];
         $returnpack[$cnt]['sclm_configurationitemtypes_id_c'] = $the_row['sclm_configurationitemtypes_id_c'];
         $returnpack[$cnt]['sclm_configurationitemtypes_id1_c'] = $the_row['sclm_configurationitemtypes_id1_c'];

         if ($returnpack[$cnt]['ci_id']){
            $ci_name = dlookup("sclm_configurationitems", "name", "id='".$returnpack[$cnt]['ci_id']."'");
            $returnpack[$cnt]['ci_name'] = $ci_name;
            $ci_type_id = dlookup("sclm_configurationitems", "sclm_configurationitemtypes_id_c", "id='".$returnpack[$cnt]['ci_id']."'");
            $returnpack[$cnt]['ci_type_id'] = $ci_type_id;
            $ci_type_name = dlookup("sclm_configurationitemtypes", "name", "id='".$ci_type_id."'");
            $returnpack[$cnt]['ci_type_name'] = $ci_type_name;
            }
         if ($returnpack[$cnt]['related_ci_id']){
            $related_ci_name = dlookup("sclm_configurationitems", "name", "id='".$returnpack[$cnt]['related_ci_id']."'");
            $returnpack[$cnt]['related_ci_name'] = $related_ci_name;
            $related_ci_type_id = dlookup("sclm_configurationitems", "sclm_configurationitemtypes_id_c", "id='".$returnpack[$cnt]['related_ci_id']."'");
            $returnpack[$cnt]['related_ci_type_id'] = $related_ci_type_id;
            $related_ci_type_name = dlookup("sclm_configurationitemtypes", "name", "id='".$related_ci_type_id."'");
            $returnpack[$cnt]['related_ci_type_name'] = $related_ci_type_name;
            }
   ...
   case 'update':
    ...
    $set_entry_params = array(
   'session' => $sugar_session_id,
              'module_name' => 'sclm_ConfigurationItemItems',
              'name_value_list'=> $params
    );
 ...
 break; // end ConfigurationItemItems
 ###############################################
 case 'ConfigurationItemItems_Common':
  ...
  switch ($action){
   ...
   $final_query = "SELECT $select FROM cmn_configurationitemitems $query $group $order $limit";
   ...
   while ($the_row = mysql_fetch_array ($the_list)){
         ...
         $returnpack[$cnt]['deleted'] = $the_row['deleted'];        
         $returnpack[$cnt]['assigned_user_id'] = $the_row['assigned_user_id'];
         $returnpack[$cnt]['ci_id'] = $the_row['cmn_configurationitems_id_c'];
         $returnpack[$cnt]['related_ci_id'] = $the_row['cmn_configurationitems_id1_c'];

         if ($returnpack[$cnt]['ci_id']){
            $ci_name = dlookup("cmn_configurationitems", "name", "id='".$returnpack[$cnt]['ci_id']."'");
            $returnpack[$cnt]['ci_name'] = $ci_name;
            $ci_type_id = dlookup("cmn_configurationitems", "cmn_configurationitemtypes_id_c", "id='".$returnpack[$cnt]['ci_id']."'");
            $returnpack[$cnt]['ci_type_id'] = $ci_type_id;
            $ci_type_name = dlookup("cmn_configurationitemtypes", "name", "id='".$ci_type_id."'");
            $returnpack[$cnt]['ci_type_name'] = $ci_type_name;
            }
         if ($returnpack[$cnt]['related_ci_id']){
            $related_ci_name = dlookup("cmn_configurationitems", "name", "id='".$returnpack[$cnt]['related_ci_id']."'");
            $returnpack[$cnt]['related_ci_name'] = $related_ci_name;
            $related_ci_type_id = dlookup("cmn_configurationitems", "cmn_configurationitemtypes_id_c", "id='".$returnpack[$cnt]['related_ci_id']."'");
            $returnpack[$cnt]['related_ci_type_id'] = $related_ci_type_id;
            $related_ci_type_name = dlookup("cmn_configurationitemtypes", "name", "id='".$related_ci_type_id."'");
            $returnpack[$cnt]['related_ci_type_name'] = $related_ci_type_name;
            }
   ...
   case 'update':
    ...
    $set_entry_params = array(
   'session' => $sugar_session_id,
              'module_name' => 'cmn_ConfigurationItemItems',
              'name_value_list'=> $params
    );
 ...
 break; // end ConfigurationItemItems_Common
 ###############################################
 ...
 case 'ConfigurationItemTypes_Common':
  ...
  switch ($action){
   ...
   $final_query = "SELECT $select FROM cmn_configurationitemtypes $query $group $order $limit";
   ...
   case 'update':
    ...
    $set_entry_params = array(
   'session' => $sugar_session_id,
              'module_name' => 'cmn_ConfigurationItemTypes',
              'name_value_list'=> $params
    );
 ...
 break; // end ConfigurationItemTypes_Common
 ###############################################
 case 'Contacts':
 case 'contacts':
 ...
 case 'Events':
  ...
  switch ($action){
   ...
   case 'select':    
    ...
    $the_list = $events_db->query("SELECT $select FROM cmv_events $query $group $order $limit");
    ...
    while ($the_row = mysql_fetch_array ($the_list)){
        ...
        $returnpack[$cnt]['view_count'] = $the_row['view_count'];
        $returnpack[$cnt]['venue_street'] = $the_row['venue_street'];
        $returnpack[$cnt]['venue_city'] = $the_row['venue_city'];
        $returnpack[$cnt]['venue_state'] = $the_row['venue_state'];
        $returnpack[$cnt]['venue_zip'] = $the_row['venue_zip'];
        $returnpack[$cnt]['venue_latitude'] = $the_row['venue_latitude'];
        $returnpack[$cnt]['venue_longitude'] = $the_row['venue_longitude'];
...
*/
    ...
    while ($the_row = mysql_fetch_array ($the_list)){
          ...
          $returnpack[$cnt]['cmv_governmentroles_id_c'] = $the_row['cmv_governmentroles_id_c'];
          $returnpack[$cnt]['cmn_countries_id_c'] = $the_row['cmn_countries_id_c'];
          $returnpack[$cnt]['cmv_countries_id1_c'] = $the_row['cmv_countries_id1_c'];
          $returnpack[$cnt]['cmv_governmentconstitutions_id_c'] = $the_row['cmv_governmentconstitutions_id_c'];
          $returnpack[$cnt]['cmv_nominees_id_c'] = $the_row['cmv_nominees_id_c'];
          $returnpack[$cnt]['cmv_causes_id_c'] = $the_row['cmv_causes_id_c'];
          $returnpack[$cnt]['sfx_actions_id_c'] = $the_row['sfx_actions_id_c'];
          $returnpack[$cnt]['sfx_effects_id_c'] = $the_row['sfx_effects_id_c'];
          $returnpack[$cnt]['cmv_statuses_id_c'] = $the_row['cmv_statuses_id_c'];
          $returnpack[$cnt]['cmv_content_id_c'] = $the_row['cmv_content_id_c'];
