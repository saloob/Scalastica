...
*/
   ...
   for ($cnt=0;$cnt < count($sclm_rows);$cnt++){
    ...
    if ($parent_account_id != NULL && $parent_account_id != $portal_account_id && ($portal_email == NULL || $portal_email_password == NULL || $portal_email_server == NULL ||  $portal_email_smtp_auth == NULL || $portal_email_smtp_port == NULL )){
       ...
       $sclm_action = "select";   
       $sclm_params = "";
       $sclm_params[0] = " deleted=0 && account_id_c='".$parent_account_id."' && (sclm_configurationitemtypes_id_c='ea0de164-0803-4551-8cc1-51fdc1881db6' || sclm_configurationitemtypes_id_c='78fdc61d-6ce5-1172-a55a-52c7048a48c7' || sclm_configurationitemtypes_id_c='c964c341-ebef-c62b-07f5-51a9cea93d17' || sclm_configurationitemtypes_id_c='723305fd-5711-83d6-1158-51aa0cfcb607' || sclm_configurationitemtypes_id_c='234cd0fc-fea8-bfb3-6253-5291aaa03b0c' || sclm_configurationitemtypes_id_c='571f4cd2-1d12-d165-a8c7-5205833eb24c' || sclm_configurationitemtypes_id_c='6fb14f09-71c7-ce07-c746-5291aa2c39c4' || sclm_configurationitemtypes_id_c='795f11f8-ab63-3948-aac3-51d777dd433c' || sclm_configurationitemtypes_id_c='12e4272a-e571-1067-44f3-51d7787a4045' || sclm_configurationitemtypes_id_c='9dc21c7b-6279-dfd3-3663-51b2f0489807' || sclm_configurationitemtypes_id_c='ad2eaca7-8f00-9917-501a-519d3e8e3b35' || sclm_configurationitemtypes_id_c='1d3da104-6fad-d1d8-719a-54d71a00b7d0' || sclm_configurationitemtypes_id_c='5e7c49e5-e48d-f53e-9c4a-54d719f5fedb' || sclm_configurationitemtypes_id_c='2f6a1ad8-2501-c5d7-025f-54d71a110296' || sclm_configurationitemtypes_id_c='cafad60b-6fab-dbd2-66d6-54d7a1988a3e' || sclm_configurationitemtypes_id_c='4a67c6fb-42d0-8cb6-84b9-54deec34066b' || sclm_configurationitemtypes_id_c='c0fed5ce-05ba-66e2-e9ae-51b2f2446f68') ";
       $sclm_params[1] = "*";
       $sclm_params[2] = "";
       $sclm_params[3] = "";
       $sclm_params[4] = "";
...
(!preg_match('/^(\\\\.|[A-Za-z0-9!#%&`_=\\/$\'*+?^{}|~.-])+$/',
 ...
 function creditisor ($params){
  ...
  $commission_type = '771c822d-0966-41d7-c00b-54e4c259bed1';

  $comm_object_type = 'ConfigurationItems';
  $comm_action = "select";
  $comm_params[0] = " sclm_configurationitemtypes_id_c='".$commission_type."' && account_id_c='".$price_account_id_c."' ";
  ...
  if ($this_currency == $credits_base_currency){
     ...
     */
     ...
     $file = 'latest.json';
     $appId = '30c42832e35445d88dbcbb232dcec12d'; # YOUR_APP_ID
     $currencies = "JPY,".$iso_code;
     # Open CURL session:
     $ch = curl_init("http://openexchangerates.org/api/{$file}?app_id={$appId}&symbols={$currencies}");
  ...
  # Not using any change sas yet - may use for payments, but until then - basic pricing based on selected currency
...
//       $search_title = $strings["action_search_via_keyword"].": ".$val;
   ...
   case 'ServicesPrices':
    ...
    $object_return = "<font size=3 color=#FBB117><B>".$strings["ServiceSLAPrice"].": </B></font><a href=\"#\" onClick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$valtype."&action=view&value=".$val."&valuetype=".$valtype."');return false\"><font size=3><B>".$object_name."</B></font></a>";

    $object_target = "<a href=\"#\" onclick=\"loader('".$BodyDIV."');doBPOSTRequest('".$BodyDIV."','Body.php', 'pc=".$portalcode."&do=".$valtype."&value=".$val."&valuetype=".$valtype."&action=view');\"><font size=2>".$object_name."</font></a>";

    $object_title = "<div style=\"".$divstyle_orange."\"><B>".$strings["ServiceSLAPrice"]." ".$comment_title."</B></div>";
...
//  $header_style = "background: #e6e6e6 url(images/ui-bg_glass_75_e6e6e6_1x400.png) 50% 50% repeat-x;margin-left:font-weight: bold;0px;border-radius:3px;margin-right:2%;margin-top:2px;padding-top:5px;padding-right:0px;padding-left:3px;border:1px solid ".$border_color.";width:100%;min-height:35px;overflow:no;color:".$header_color.";";
  ...
  $body_style = "margin-left:1%;border-radius:3px;margin-right:1%;padding-top:0px;padding-right:2px;padding-left:2px;padding-bottom:15px;border:1px solid ".$border_color.";min-width:".$bodywidth_top.";min-height:".$height.";overflow:auto;background-color:".$body_color.";";

  $footer_style = "margin-left:1%;border-radius:3px;margin-right:1%;padding-right:2px;padding-left:2px;border:1px solid ".$border_color.";min-width:".$bodywidth_top.";min-height:10px;overflow:no;background-color:".$footer_color.";";
...
function get_body_attach ($mbox, $mid) {
  ...
  if (isset($struct->parts) && is_array($struct->parts) && isset($struct->parts[1])) {
     ...
     if ($encode == 0){
        ...
        #   }
           ...
           if (in_array($subjectcharset,$baseexceptions)){
              ...
              #echo "<P>Subjectcharset: ".$subjectcharset."<P>";
      ...
      echo "PARTS: Subtype: ".$subtype." part->encoding ID: ".$mid." Encode :".$encode." && Charset: ".$charset."<BR>";
     ...
     echo "NO PARTS: struct->encoding ID: ".$mid." Encode :".$encode." && Charset: ".$charset."<BR>";
   ...
   if (is_array($ipserver_pack)){
      ...
      if ($ipservermatch == TRUE){
         ...
         if ($match != FALSE){
            ...
            if ($create_report == TRUE){
               $inner_report .= $debugger." There was no other hit so just a server hit is not good enough to make TRUE<BR>";
               }
...
*/
   ...
   if ($match == TRUE){
      ...
      if (is_array($contentpack)){
         ...
         foreach ($contentpack as $fid=>$fileid){
                 ...
                 $content_link = $this->encrypt($content_link);
   ...
   if ($match == TRUE && ($create_ticket == TRUE || $create_activity == TRUE)){
      ...
      if (is_array($config_items)){
         ...
         for ($configcnt=0;$configcnt < count($config_items);$configcnt++){
             ...
             if ($create_report == TRUE){
                $inner_report .= $debugger." New TicketActivity ID: ".$ticket_id."<BR>";
                }
      ...
      if ($create_activity == TRUE){
         ...
         $email_title = $this->replacer("[TICKET]", $ticket_date, $email_title);
         $email_content = $this->replacer("[TICKET]", $ticket_date, $email_content);
   ...
   if ($debug_filter_folder != NULL && $debug_ticket_folder != NULL){
      ...
      $inner_report = $this->move_emails($moveparams);
     ...
     for ($mailcnt=0;$mailcnt < count($imapemails);$mailcnt++){
         ...
         if ($body != NULL){
            ...
            if ($body != strip_tags($body)) {
               ...
               $body = $this->replacer("<br>", "SCALASTICABR", $body); # Break
               $body = $this->replacer("\n", "SCALASTICANL", $body); # New Line
               #$body = $this->replacer("\n", "<br>", $body);
               $body = strip_tags($body);
               #$body = $this->replacer("\n", "<br>", $body);
               if ($source == 'Emails'){
                  $body = $this->replacer("SCALASTICABR", "\n", $body);
                  $body = $this->replacer("SCALASTICANL", "\n", $body);
                  } else {
                  $body = $this->replacer("SCALASTICABR", "\n", $body);
                  $body = $this->replacer("SCALASTICANL", "\n", $body);
                  }
         ...
         if ($valtype == 'test_filter_all_live' || $valtype == 'test_filter_all_debug' || $valtype == 'test_filter_single_debug' || $valtype == 'test_filter_single_live'){
            ...
            if (is_array($srvcap_strings)){
               ...
               for ($srvcap_cnt=0;$srvcap_cnt < count($srvcap_strings);$srvcap_cnt++){
                   ...
                   $endcheck = "";
                   $message_source = "";
                   $startcheck = $this->replacer($srv_part_start, "", $body);
                   $endcheck = $this->replacer($srv_part_end, "", $body);
                   ...
                   if ($startcheck == $body || $endcheck == $body){
                      ...
                      $srv_replace = $this->replacer("\n", "", $srv_replace);
                      $srv_replace = $this->replacer(".agc.jp", "", $srv_replace);
                      $srv_replace = $this->replacer(" ", "", $srv_replace);
                  ...
                  if (is_array($acttickets)){
                     ...
                     for ($cntactkt=0;$cntactkt < count($acttickets);$cntactkt++){
                         ...
                         if ($subject != $this->replacer($ticket_id,"",$subject)){
                            ...
                            } else {// end if ($subject != $this->replacer($ticket_id,"",$subject)){
                             $create_activity = FALSE;
                            }
...
*/
 ...
 $drop_down_return = "<select name=$label id=$label onChange=\"loader('".$tbl."');getjax('getjax.php?do=".$do."&action=".$action."&valuetype=".$valtype."&value=".$val."&tbl=".$tbl.$added_params."&currval=".$current_value."&id='+this.value,'".$tbl."');\">";
...
if (!class_exists('gallery')){
 ...
 if (is_array($dd_pack)){
    ...
    while (list($key, $value) = each($dd_pack)){
          ...
          if ($current_value==$key || $checkstate == 1){
             $checkimage = "<input type=\"".$type."\" name=\"".$newkey."\" id=\"".$newkey."\" value=\"".$key."\" checked>".$image;
             } else {
             $checkimage = "<input type=\"".$type."\" name=\"".$newkey."\" id=\"".$newkey."\" value=\"".$key."\">".$image;
             }

          $checkimage = "<td style=\"width:400px;min-height:150;\"><img src=images/blank.gif width=10 height=50> ".$checkimage."</td>";
...
*/
 ...
 $drop_down_return = "<div style=\"width:350px;min-height:150;max-height:350;overflow:auto;\">". $drop_down_return."</div>";
...
#     $drop_down_return = "<select id=$label name=$label>";
     ...
     $drop_down_return = "<select id=$label name=$label style=\"font-family: v; font-size: 10pt; color: #5E6A7B; border: 1px solid #5E6A7B; padding-left: 4; padding-right: 4; padding-top: 1; padding-bottom: 1\">";
   ...
   switch ($action){
	...
	text-shadow:
     ...
     if ($button_text != 'None'){
        ...
        $the_button = $button_style."<div><button type=\"button\" name=\"button\" value=\"".$button_text."\" onclick=\"get(this.form);return false\" class=\"css3button\">".$button_text."</div>"; 
