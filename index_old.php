...
$body_part = "<div style=\"float:left;margin-top:15px;margin-left:2px;margin-right:2px;padding-top:0px;padding-left:4px;padding-right:0px;min-height:100px;width:".$bodycolumnwidth.";\" id=\"".$BodyDIV."Container\">
...
<html xmlns="http://www.w3.org/1999/xhtml" itemscope itemtype="http://schema.org/Article">
 <head> 
  ...
  <style>
  #GRID { width: 100%; max-height:500px;overflow:scroll; padding: 0.5em; }
