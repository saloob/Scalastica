(function ($) {
    ...
    Apperyio.refreshScreenFormElements = function (screen) {
        ...
        try {
            ...
            // JQM elements
            ctx.find("input[type='radio']:data(mobile-checkboxradio), input[type='checkbox']:data(mobile-checkboxradio)").checkboxradio("refresh");
            ...
            ctx.find("ul[data-role='listview']:visible:not([_idx]), ol[data-role='listview']:not([_idx])").listview('refresh');
